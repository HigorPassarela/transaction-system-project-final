...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, TransacaoEvento> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "notifications-service-group");
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, TransacaoEvento.class.getName());
